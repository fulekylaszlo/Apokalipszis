    ...
    if (választás_első == 1)
        {
            ...
            vissza_választás_második: if (választás_második == 1)
                    ...
                    else if (választás_második == 2)
                        {
                            ...
                            cout << "1.Kés: "<< vásárlásT[0] <<"x"<< endl;
                            cout << "2.Élelem: " << vásárlásT[1] <<"x"<< endl;
                            cout << "3.Víz: " << vásárlásT[2] <<"x"<< endl;
                            cout << "4.Gránát: " << vásárlásT[3] <<"x"<< endl;
                            cout << "5.Kötszer: " << vásárlásT[4] <<"x"<< endl;
                            cout << "6.Kabát: " << vásárlásT[5] <<"x"<< endl;
                            
                            
                            vissza_miből:  cout << "Kereskedő: Mondd, miből mennyit kérsz ?" << endl;
                            cin >> vásárlás;
                                if (vásárlás <= 1 || vásárlás >=6)
                                {
                                    cout << BOLDRED << "Helytelen gomblenyomás, kérlek '[1-6]' közül válassz! " << RESET << endl;
                                }
                            cout << "Kereskedő: " << (vásárlásT [vásárlás - 1] - mennyit) << " darab van, mennyit kérsz ?" << endl;
                            cin >> mennyit;
                            
                            
                            cout << "Kereskedő: " << " Adom is!" << endl;
                            cout << "Kereskedő: Szeretnél még vásárolni ?" << endl;
                            cin >> mégvásárlás;
                            
                                if (mégvásárlás == 1)
                                    {
                                        cout << "Kereskedő: Rendben" << endl;
                                        goto vissza_miből;
                                    }
                                else if (mégvásárlás == 2)
                                    {
                                        cout << "Kereskedő: Rendben, akkor viszont látásra !" << endl;
                                        cout << "Te: A viszont látásra!" << endl;
                                    }
                        }
